...
Route::group(
    ...
    function () {
        ...
        Route::get('/master-produk-hukum', [Filecontroller::class, 'index'])->name('master.file');
        Route::get('/master-produk-hukum-detail/{id}', [Filecontroller::class, 'detail'])->name('master.file.detail');
        Route::get('/master-produk-hukum-proses/{id}', [Filecontroller::class, 'proses'])->name('master.file.proses');
        Route::get('/master-produk-hukum-update/{id}', [Filecontroller::class, 'update'])->name('master.file.update');
        Route::get('/master-produk-hukum-publish/{id}', [Filecontroller::class, 'publish'])->name('master.file.publish');
        Route::get('/master-produk-hukum-tolak/{id}', [Filecontroller::class, 'tolak'])->name('master.file.tolak');
        Route::post('/master-file-datatable', [Filecontroller::class, 'datatable'])->name('master.file.datatable');
        Route::get('/master-file-tambah', [Filecontroller::class, 'tambah'])->name('master.file.tambah');
        ...
        Route::post('/master-katalog-cetak', [KatalogController::class, 'cetak_pdf'])->name('master.katalog.cetak');

        Route::get('/master-katalog-cetak2', [KatalogController::class, 'cetak_pdf2'])->name('master.katalog.cetak2');
