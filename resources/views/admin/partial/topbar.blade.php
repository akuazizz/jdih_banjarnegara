    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div class="brand aside-logo flex-column-auto" id="kt_aside_logo">
                ...
                <span class="fw-bolder text-white font-size-h6 pl-2 sm:text-left" id="text-logo">Banjarnegara</span>

                <!--end::Logo-->
                <!--begin::Aside toggler-->
                <div id="kt_aside_toggle" class="btn btn-icon w-auto px-0 aside-toggle" data-kt-toggle="true"
            ...
            <div class="aside-menu flex-column-fluid">
                <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                    ...
                    data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0" style="height: 346px;">
            ...
            c-0.323,0-0.611,0.201-0.723,0.505l-2.011,5.505L1.992,4.644H8.203z M15.276,15.356H3.882l2.515-6.879H17.79L15.276,15.356z">
                        ...
                        <div class="menu-item menu-accordion">
                            <a class="menu-link" href="{{ route('admin.master.file.putusan') }}">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg class="svg-icon" viewBox="0 0 20 20">
                                            <path fill="none"
            ...
            c-0.323,0-0.611,0.201-0.723,0.505l-2.011,5.505L1.992,4.644H8.203z M15.276,15.356H3.882l2.515-6.879H17.79L15.276,15.356z">
                        ...
                        @if (auth()->user()->roleName->roles_name == 'superadmin' || auth()->user()->roleName->roles_name == 'admin')
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('admin.master.tupoksi') }}">
                                            ...
                                            <span class="menu-title">Tupoksi Bagian Hukum</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                        ...
                        <div class="d-flex align-items-stretch flex-shrink-0">
                            ...
                            <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                    ...
                                    <img src="{{ asset('media/logo_jdih_banjarnegara.png') }}" alt="user" />
                                </div>
