                                                ...
                                                <td>
                                                    @if ($d->file != '')
                                                        <img style="max-width:200px;max-height:200px;"
                                                            src="{{ asset('galeri/' . $d->file) }}">
                                                    @else
                                                        <iframe style="max-width:200px;max-height:200px;"
                                                            src="{{ $d->link }}" title="YouTube video player"
                                                            frameborder="0"
                                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                            allowfullscreen></iframe>
                                                    @endif
                                                </td>
                                                <td><a class="btn btn-sm btn-danger hapusb"
                                                        id="{{ $d->id }}">Hapus</a></td>
                                            </tr>
                                        @endforeach
                                    @endif
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="link" value=""
                                    placeholder="masukan kode Link embed youtube">
                            </div>
                        </div>
                    </form>
                </div>
