                                    ...
                                    <div class="mb-8">
                                        ...
                                        <div class="d-flex flex-wrap mb-6">
                                            ...
                                            <div class="me-9 my-1">
                                                ...
                                                <!--begin::Label-->
                                                <span
                                                    class="fw-bolder text-gray-400">{{ date('d F Y', strtotime($berita->tgl)) }}</span>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                        ...
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="text-dark text-hover-primary fs-2 fw-bolder">{{ $berita->nama }}
                                        ...
                                        <div class="overlay mt-8">
                                            ...
                                            <div
                                                ...
                                                <center><img src="{{ asset('berita/' . $berita->images) }}" width:auto;>
                                                </center>
                                            </div>
                                            <!--end::Image-->
                                        </div>
