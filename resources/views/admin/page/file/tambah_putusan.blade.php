        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Form Tambah Putusan</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
            </div>
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Form Tambah Putusan</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                            ...
                            <form id="post_file" class="form" action="#" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                type="text" placeholder="T.E.U" id="teu" name="teu" required />
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                id="singkatan_jenis_peradilan" name="singkatan_jenis_peradilan" required />
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                ...
                                                name="tempat_peradilan" required />
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#simpanfile').on('click', function(e) {
                ...
                Swal.showLoading()
                axios.post('{{ route('admin.master.file.putusan.tambah.store') }}', formData)
                    .then(function(response) {

                        if (response.status === 200) {
                            Swal.fire({
                                text: "Putusan baru berhasil dibuat!",
                                icon: "success",
                            }).then(() => {
                            ...
                            Swal.fire({
                                text: "Putusan baru gagal dibuat!",
                                icon: "error",
                            });
