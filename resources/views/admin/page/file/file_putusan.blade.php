        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data Putusan<h1>
                            <!--begin::Separator-->
                    ...
                    <div class="card card-flush h-xl-100">
                        <div class="card-header">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-gray-800">Data Putusan</span>
                            </h3>
                            <div class="card-title align-items-end flex-column">
                                <a href="{{ route('admin.master.file.putusan.tambah') }}" class="btn btn-danger"><i
...
@section('script')
    ...
    <script>
        var tablefile = $('#datatables').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '{{ route('admin.master.file.putusan.datatable') }}',
                type: 'post',
                data: function(d) {
                    d._token = "{{ csrf_token() }}"
                    d.judul = $('#judul').val()
        ...
        $('#datatables tbody').on('click', '.hapusfile', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.showLoading()
                    $.ajax({
                        url: '{{ route('admin.master.file.putusan.delete') }}',
                        type: 'post',
                        data: {
                            idf: id,
                            _token: "{{ csrf_token() }}"
