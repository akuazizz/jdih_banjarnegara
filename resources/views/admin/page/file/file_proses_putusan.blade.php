                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <table class="table table-row-dashed align-middle gs-0 gy-4" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td width="25%"><strong>Tipe Dokumen</strong></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ Helper::string_rmv_html($data->content) }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><strong>Jenis Peradilan</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->jenis_peradilan }}</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Singkatan Jenis Peradilan</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->singkatan_jenis_peradilan }}</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Tempat Peradilan</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->tempat_peradilan }}</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Tanggal Dibacakan</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->tgl_dibacakan != '0000-00-00' ? Helper::tgl_indo($data->tgl_dibacakan) : '' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span>
                                                            <a class="font-white "
                                                                href="#">{{ $data->file_tags }}</a>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Status Putusan</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->status_putusan }}</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Bahasa</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $bahasa ?? $data->bahasa }}</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Bidang Hukum</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->bid_hukum }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->tahun_diundang }}</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Author</strong></td>
                                                    <td class="text-center">:</td>
                                                    <td>{{ $data->file_author }}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        @if ($data->publish == 1)
                                            <a href="{{ route('admin.master.file.putusan.publish', [$data->id]) }}"
                                                class='btn btn-danger' id='aktif'>Unpublish</a>
                                        @elseif ($data->publish == 0)
                                            <a href="{{ route('admin.master.file.putusan.publish', [$data->id]) }}"
                                                class='btn btn-success' id='aktif'>Publish</a>
                                        @elseif ($data->publish == 3)
                                            <a class="text-danger">*Putusan Ditolak</a>
                                        @else
                                            <a href="{{ route('admin.master.file.putusan.publish', [$data->id]) }}"
                                                class='btn btn-success' id='btn-terima'>Terima </a>
                                            <a href="{{ route('admin.master.file.putusan.tolak', [$data->id]) }}"
                                                class='btn btn-danger' style="margin:5px;" id='btn-tolak'>Tolak </a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="mt-list-container list-simple bg-white">
                                                    <div class="d-flex flex-stack flex-wrap mb-10">
                                                        <div class="d-flex align-items-center py-1">
                                                            ...
                                                            <a href="{{ asset($data->file_url) }}"
                                                                class="fs-3 fw-bold text-gray-900 text-hover-danger">Pratinjau</a>
                                                        </div>
                                                        <div class="d-flex align-items-center py-1">
                                                            <div class="symbol symbol-35px me-2">
                                                                <span class="svg-icon svg-icon-dark svg-icon-2x">
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="{{ asset($data->file_url) }}"
                                                                    class="fs-3 fw-bold text-gray-900 text-hover-danger">{{ $data->file }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p class="font-sm font-red-intense text-red-600">
                                                        * Klik pada nama file untuk melakukan download atau klik pada tombol
                                                        pratinjau untuk melihat file.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        $('#btn-terima').click(function(e) {
            ...
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Putusan akan diterima, apakah anda yakin?',
                icon: 'question',
