    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ $data->singkatan_jenis }} NOMOR
                        ...
                        <form id="post_file" class="form" action="#" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <select class="form-select form-select-solid mb-3 mb-lg-0" id="tipe_dokumen"
                                            data-kt-select2="true" required>
                                            <option>-- Pilih Tipe --</option>
                                            <option <?= isset($data) && $data->tipe_dokumen == '1' ? 'selected' : '' ?>
                                                value="1">Peraturan Perundangan-undangan</option>
                                            <option <?= isset($data) && $data->tipe_dokumen == '2' ? 'selected' : '' ?>
                                                value="2">Monografi Hukum</option>
                                            <option <?= isset($data) && $data->tipe_dokumen == '3' ? 'selected' : '' ?>
                                                value="3">Artikel Hukum</option>
                                            <option <?= isset($data) && $data->tipe_dokumen == '4' ? 'selected' : '' ?>
                                                value="4">Putusan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Kategori Produk
                                        Hukum</label>
                                    <div class="col-8">
                                        <select class="form-select form-select-solid mb-3 mb-lg-0" id="jenis"
                                            data-kt-select2="true" required>
                                            <option>-- Pilih Kategori --</option>
                                            @foreach ($kategori as $k)
                                            <option <?= isset($data) && $data->jenis == $k->id ? 'selected' : '' ?>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Nomor Peraturan" id="no_peraturan"
                                            name="no_peraturan"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Pengarang" id="pengarang" name="pengarang"
                                            value="{{ isset($data) && $data != '' ? $data->pengarang : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Di
                                        tetapkan</label>
                                    <div class="col-8">
                                        <input
                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 pilihtanggal"
                                            type="text" placeholder="Tanggal Di tetapkan" id="tgl_ditetapkan"
                                            name="tgl_ditetapkan"
                                            value="{{ isset($data) && $data != '' ? $data->tgl_ditetap : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Di
                                    ...
                                    <div class="col-8">
                                        <input
                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 pilihtanggal"
                                            type="text" placeholder="Tanggal Di Undang" id="tgl_diundang"
                                            name="tgl_diundang"
                                            value="{{ isset($data) && $data != '' ? $data->tgl_diundang : '' }}" />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <textarea class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="tentang" id="tentang"
                                            required>{{ isset($data) && $data != '' ? $data->content : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Tags</label>
                                    <div class="col-8">
                                        <select class="form-control form-select" id="tags" name="tags"
                                            multiple="multiple">
                                            <option></option>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <iframe
                                            src="{{ asset('produk_hukum/abstrak/' . $abstrak->file_abstrak . '') }}"
                                            style="width:300px; height:300px;" frameborder="0"></iframe><br>
                                        @else
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Tempat Terbit" id="tempat_terbit"
                                            name="tempat_terbit"
                                            value="{{ isset($data) && $data != '' ? $data->tmp_terbit : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Penerbit" id="penerbit" name="penerbit"
                                            value="{{ isset($data) && $data != '' ? $data->penerbit : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            ...
                                            value="{{ isset($data) && $data != '' ? $data->sumber : '' }}" />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Pemrakarsa" id="pemrakarsa"
                                            name="pemrakarsa"
                                            value="{{ isset($data) && $data != '' ? $data->pemrakarsa : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Penandatangan" id="penandatangan"
                                            name="penandatangan"
                                            value="{{ isset($data) && $data != '' ? $data->penandatangan : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            ...
                                            value="{{ isset($data) && $data != '' ? $data->tajuk_entri_utama : '' }}"
                                            required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="ISBN" id="isbn" name="isbn"
                                            value="{{ isset($data) && $data != '' ? $data->isbn : '' }}" />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="No Panggil" id="no_panggil"
                                            name="no_panggil"
                                            value="{{ isset($data) && $data != '' ? $data->no_panggil : '' }}" />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="No Induk Buku" id="no_induk_buku"
                                            name="no_induk_buku"
                                            value="{{ isset($data) && $data != '' ? $data->no_induk_buku : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Deskripsi
                                        Fisik</label>
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" placeholder="Deskripsi Fisik" id="deskripsi_fisik"
                                            name="deskripsi_fisik"
                                            value="{{ isset($data) && $data != '' ? $data->deskripsi_fisik : '' }}"
                                            required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            ...
                                            value="{{ isset($data) && $data != '' ? $data->file_author : '' }}" required />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Hasil Uji
                                        Materi</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Keterangan
                                        Status</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        ...
                                        @endif
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="file" placeholder="Invertarisasi Hukum" id="file"
                                            name="file" />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <select class="form-select form-select-solid form-control-lg"
                                            ...
                                            <option <?= isset($data) && $data->status == 1 ? 'selected' : '' ?>
                                                value="1">Berlaku</option>
                                            <option <?= isset($data) && $data->status == 0 ? 'selected' : '' ?>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <small class="text-muted">Pilih dokumen yang terkait dengan produk hukum ini (opsional)</small>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <button type="sumbit" class="btn btn-success mr-2" id="simpanfile"><i
...
<script src="https://cdn.tiny.cloud/1/h9q0rvctciw5bplv4gbolgbey1emeujtwsebnxwz07r0w97o/tinymce/6/tinymce.min.js"
