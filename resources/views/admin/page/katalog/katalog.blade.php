                                    ...
                                    @if (isset($katalog))
                                        @foreach ($katalog as $k)
                                            <tr>
                                                ...
                                                <td>{{ $k->name }}</td>
                                                <td>{{ $k->tahun }}</td>
                                                <td><iframe src="{{ asset('katalog_download/' . $k->file) }}"
                                                        style="width:300px; height:300px;" frameborder="0"></iframe></td>
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-danger hapusfile"
                                                        id="{{ $k->id }}">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                ...
                <div class="modal-body">
                    <form id="form-filter">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="file" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                    id="file">
                            </div>
                        </div>
                    </form>
