                        ...
                        <div class="form-group row mb-4 mt-4">
                            <div class="col-3">
                                <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                    id="judul" name="judul" placeholder="tentang produk hukum" />
                            </div>
                            <div class="col-2">
                                <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                    id="nomor" name="nomor" placeholder="masukan nomor" />
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                ...
                                <a href="#" class="btn btn-lg btn-warning" id="print"><i
                                        id="loading"></i>Print</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        $('#print').on('click', function() {
            ...
            let judul = $('#judul').val()
            var url =
                `{{ route('admin.master.katalog.cetak2') }}?kat=${kat}&nomor=${nomor}&tahun=${tahun}&judul=${judul}`
