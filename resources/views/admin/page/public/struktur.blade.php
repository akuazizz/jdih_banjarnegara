        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">JDIH Kabupaten Banjarnegara<h1>
                            <!--begin::Separator-->
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-title align-items-end flex-column">
                                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#tambahvm"><i class="fa fa-plus"></i>Update Struktur Organisasi</a>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width:150%;">
                <div class="modal-header text-center">
                    <h5 class="modal-title" id="exampleModalLabel">Update Struktur Organisasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="form-filter">
                        <div class="mb-3 row">
                            <label class="col-sm-12 col-form-label">Struktur Organisasi</label>
                            <div class="col-sm-12">
                                <textarea class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" id="vm" rows="3"
                                    name="vm"></textarea>
                            </div>
                        </div>
                    </form>
...
@section('script')
    ...
    <script>
        $('#tambahphproses').on('click', function() {
            ...
            axios({
                    method: "post",
                    url: "{{ route('admin.master.struktur.store') }}",
                    data: {
                        isi: bodyvm,
