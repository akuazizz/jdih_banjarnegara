                        ...
                        <div class="card card-custom">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text"id="no_peraturan"
                                            value="{{ isset($user) && $user != '' ? $user->email : '' }}" readonly />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                            type="text" id="role"
                                            value="{{ isset($user) && $user != '' ? $user->roles_name : '' }}" readonly />
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <button type="button" class="btn btn-success mr-2" id="simpanProfile"><i
