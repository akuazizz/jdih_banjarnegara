                                    ...
                                    @if (isset($data))
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                <td>{{ $d->rakor }}</td>
                                                <td>{{ $d->tgl }}</td>
                                                <td> <iframe src="{{ asset('download/' . $d->file) }}"
                                                        style="width:300px; height:300px;" frameborder="0"></iframe></td>
                                                <td>
                                                    <a class="btn btn-sm btn-danger hapusb"
                                                        id="{{ $d->id }}">Hapus</a>
                                                    <a class="btn btn-sm btn-warning editd" data-bs-toggle="modal"
                                                        data-bs-target="#edit" id="{{ $d->id }}">edit</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                ...
                <div class="modal-body">
                    <form id="form-filter">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="rakor" value=""
                                    placeholder="masukan Rakor">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-sm-12 col-form-label">Tanggal</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control pilihtanggal" id="tgl" value=""
