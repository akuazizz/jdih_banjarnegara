        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-filter">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="kategori" value=""
                                    placeholder="masukan Jenis Produk Hukum baru anda">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-sm-12 col-form-label">singkatan Produk Hukum Baru</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="singkatan" value=""
                                    placeholder="masukan Jenis Produk Hukum baru anda">
                            </div>
                        </div>
                        <div class="mb-3 row">
                ...
                <div class="modal-footer">
                    <button id="tambahkategoriproses" type="button" class="btn btn-primary btn-filter"><i
                            id="loadinggantikontak"></i>
                        Simpan
                    </button>
                </div>
            </div>
