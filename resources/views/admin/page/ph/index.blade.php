        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data Master Pelayanan Hukum
                        Elektronik</h1>
                    <!--begin::Separator-->
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="name" value=""
                                    placeholder="masukan nama Pelayanan Hukum Elektronik">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="file" class="form-control" id="logo" value=""
                                    placeholder="masukan logo Pelayanan Hukum Elektronik">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="link" value=""
                                    placeholder="masukan link Pelayanan Hukum Elektronik">
                            </div>
                        </div>
                    </form>
                </div>
