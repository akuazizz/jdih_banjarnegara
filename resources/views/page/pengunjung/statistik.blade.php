    ...
    <script>
        ...
        var databulantahunterbaru = {
            ...
            datasets: [{
                ...
                label: '{{ __('Keputusan Bupati') }}',
                backgroundColor: "#FF7043",
                data: data_kepgub
            }, {
                label: '{{ __('Instruksi Bupati') }}',
        ...
        //KATEGORI
        var nama = ["Surat Edaran","Rekomendasi Kajian","Peraturan Bupati","Peraturan Daerah","Naskah Akademik","Keputusan Bupati","Katalog Produk Hukum","Instruksi Bupati"];
                            ...
                            <table class="styled-table tahunan_table">
                                ...
                                <tbody class="tbody_tahunan">
                                    ...
                                    <tr class="active-row">
                                        ...
                                        <td class="sticky-col_td_2 second-col">Peraturan Bupati</td>
                                        @foreach($tahunan_perundangan as $item)
                                    ...
                                    <tr class="active-row">
                                        ...
                                        <td class="sticky-col_td_2 second-col">Keputusan Bupati</td>
                                        @foreach($tahunan_perundangan as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="sticky-col_td_1 second-col">Instruksi Bupati</td>
                                        @foreach($tahunan_perundangan as $item)
