...
<footer class="footer-eleven">
    <div class="container">
        ...
        <div class="d-flex align-items-center mb-4">
            <img src="{{ asset('media/Banjarnegara.png') }}" alt="Logo JDIH" style="height: 60px; margin-right: 10px;">
                ...
                <div class="footer-widget">
                    ...
                    <div class="map-container" style="overflow:hidden;">
                        <iframe
                            ...
                            width="110%" height="250" style="border:0; margin-left:-20px;" 
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-widget">
                    ...
                    <div class="stats-list">
                        ...
                        <div class="d-flex justify-content-between align-items-center"><span>Daily</span><span class="badge">21</span></div>
                        <div class="d-flex justify-content-between align-items-center"><span>Weekly</span><span class="badge">8133</span></div>
                        <div class="d-flex justify-content-between align-items-center"><span>Monthly</span><span class="badge">44217</span></div>
                        <div class="d-flex justify-content-between align-items-center"><span>Yearly</span><span class="badge">56383</span></div>
                    </div>
                    ...
                    <div class="stats-list">
                        ...
                        <div class="d-flex justify-content-between align-items-center"><span>Sangat Puas</span><span class="badge">1364</span></div>
                        <div class="d-flex justify-content-between align-items-center"><span>Puas</span><span class="badge">421</span></div>
                        <div class="d-flex justify-content-between align-items-center"><span>Kurang Puas</span><span class="badge">49</span></div>
                        <div class="d-flex justify-content-between align-items-center"><span>Tidak Puas</span><span class="badge">61</span></div>
                    </div>
                </div>
            </div>
