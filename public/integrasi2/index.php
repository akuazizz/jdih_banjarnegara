...
$servername = "103.110.4.130";//diisi nama server
$username = "jdih.banjarnegarakab.go.id-v2";//diisi nama user db
$password = "Spk2rZEwTpcsrDpj";//diisi password db
$dbname = "jdih.banjarnegarakab.go.id-v2";//diisi nama database
$varjson = array();
...
$row_array->urlDetailPeraturan='https://jdih.dprd.banjarnegarakab.go.id/dokumen/view?id='.$row["sc_id"]; //berisi url halaman detail peraturan silahkan ganti s..........
